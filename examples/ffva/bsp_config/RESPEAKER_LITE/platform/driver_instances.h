...
/* ReSpeaker Lite GPIO bit definitions */
#define PIN_MUTE_DET_IN     (1 << 4) /* PORT_GPI, X0D40, 8D4 */
#define PIN_BUT_A_IN        (1 << 5) /* PORT_GPI, X0D41, 8D5 */
#define PIN_X0D42           (1 << 6) /* PORT_GPI, X0D42, 8D6, TP12 */
#define PIN_X0D43           (1 << 7) /* PORT_GPI, X0D43, 8D7, TP13 */
#define PIN_X0D33           (1 << 7) /* PORT_GPO, X0D33, 8C7 */
#define PIN_RST_DAC_OUT     (1 << 6) /* PORT_GPO, X0D32, 8C6 */
#define PIN_AMP_EN_OUT      (1 << 5) /* PORT_GPO, X0D31, 8C5 */
#define PIN_WS2812_OUT      (1 << 4) /* PORT_GPO, X0D30, 8C4 */
