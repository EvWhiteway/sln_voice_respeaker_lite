...
/*
 * Board support package for ReSpeaker Lite
 */
...
/*  DFU Settings                         */
/*****************************************/
#define RESPEAKER_LITE_BOOT_PARTITION_SIZE 0x200000
#define RESPEAKER_LITE_QSPI_SPEC_COUNT 3
